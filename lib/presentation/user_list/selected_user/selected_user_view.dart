...
class SelectedListViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseWidget<SelectedListViewModel>(
      viewModel: SelectedListViewModel(Provider.of(context), Provider.of(context), Provider.of(context)),
      onModelReady: (model){
  ...
  Widget _buildList(SelectedListViewModel model){
        ...
        children: [
          Padding(
            ...
            child: InkWell(
              ...
              child: Center(child: Text('Delete All Users', style: TextStyle(color: Colors.white),)),
            )),
          ),
          Padding(
            padding: EdgeInsets.all(10),
            child: InkWell(
              onTap: (){
                ...
                model.deleteUser(model.userIds);
                model.userIds.clear();
              ...
              color: Colors.red.withOpacity(0.6),
              padding: EdgeInsets.all(8),
              child: Center(child: Text('Delete Selected Users', style: TextStyle(color: Colors.white),)),
            )),
          ),
          Expanded(
            child: ListView.builder(
              ...
              itemCount: model.userBox
                  .length, //+1 for the CupertinoActivityIndicator
              itemBuilder: (context, index) {

                final userItem = model.userBox.getAt(index) as User;
                if (index == model.userBox.length) {
                  return Container(
                    width: 120,
                    height: 290,
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color:!userItem.isSelected ? Colors.green[300]:Colors.red[300],
                        width: 2,
                      ),
                      color: !userItem.isSelected? Colors.green[300]:Colors.red[300],
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: [
                            IconButton(icon: Icon(Icons.delete, color: Colors.white.withOpacity(0.6),),
                                onPressed: (){
                              model.userIds.add(userItem.id.toString());
                              model.deleteUser(model.userIds);
                              model.userIds.clear();
                            })
                          ],
